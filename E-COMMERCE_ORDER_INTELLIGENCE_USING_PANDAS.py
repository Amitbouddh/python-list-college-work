...
orders = pd.read_csv(
    r"try\tasks\olist_orders_dataset.csv"
)

customers = pd.read_csv(
    r"try\tasks\olist_customers_dataset.csv"
)

order_items = pd.read_csv(
    r"try\tasks\olist_order_items_dataset.csv"
)

products = pd.read_csv(
    r"try\tasks\olist_products_dataset.csv"
)

payments = pd.read_csv(
    r"try\tasks\olist_order_payments_dataset.csv"
)
